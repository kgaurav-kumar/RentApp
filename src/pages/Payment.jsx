          ...
          <div className="animate-fade-in">
            ...
            <div style={{ marginTop: '2rem', borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '1.5rem' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'center', gap: '1.5rem', flexWrap: 'wrap' }}>
                <a href={`tez://upi/pay?pa=${upiId}&pn=${encodeURIComponent(upiName)}&am=${totalDue}&cu=INR`} target="_top" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.5rem', textDecoration: 'none' }}>
                ...
                <a href={`phonepe://pay?pa=${upiId}&pn=${encodeURIComponent(upiName)}&am=${totalDue}&cu=INR`} target="_top" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.5rem', textDecoration: 'none' }}>
                  <div style={{ width: '56px', height: '56px', borderRadius: '50%', backgroundColor: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 6px rgba(0,0,0,0.1)', overflow: 'hidden', padding: '4px' }}>
                ...
                <a href={`paytmmp://pay?pa=${upiId}&pn=${encodeURIComponent(upiName)}&am=${totalDue}&cu=INR`} target="_top" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.5rem', textDecoration: 'none' }}>
                  <div style={{ width: '56px', height: '56px', borderRadius: '50%', backgroundColor: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 6px rgba(0,0,0,0.1)', overflow: 'hidden', padding: '4px' }}>
